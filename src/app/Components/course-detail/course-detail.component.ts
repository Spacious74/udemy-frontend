...
export class CourseDetailComponent implements OnInit, OnDestroy {
  ...
  addProductToLocalStorage() {
    ...
    // this.cartStateService.addToCart(obj);
  ...
  addToCart() {
    ...
    this.loading = true;
    this.cartStateService.addToCart(this.userDetails?._id,this.selectedCourse._id, this.selectedCourse);
    this.toastMsgService.showSuccess("Success", "Course added to cart");
    this.existInCart = true;
    this.loading = false;
